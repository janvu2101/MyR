...
Some popular data types: integer, numeric, character, logical (boolean), complex
### Logical or boolean data type
- only 2 values **TRUE** or **FALSE** (in syntax we can use **T** or **F**)
  

```{r}
#Overally check data type of dataframe
str(df)
```
